...
export const AudienceOverlapDetector: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-3xl font-bold text-slate-800 mb-2">Audience Overlap Detector</h2>
        <p className="text-slate-600">Identifiez et optimisez les chevauchements d'audiences cross-platform</p>
      </div>
