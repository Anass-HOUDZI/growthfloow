  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slave-600">Analysez et optimisez vos campagnes Facebook en temps réel</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-slate-600">CTR Moyen</p>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-slate-600">ROAS Total</p>
