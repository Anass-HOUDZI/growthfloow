  ...
  return (
    <div className="flex flex-col items-center justify-center w-full px-2 md:px-0 py-8">
      <div className="flex flex-col items-center justify-center w-full max-w-3xl mb-8">
        <div className="mb-4">
          <div className="flex items-center justify-center w-[68px] h-[68px] rounded-2xl bg-gradient-to-br from-purple-500 to-blue-500 shadow-lg shadow-purple-200/25">
        ...
        <p className="text-lg md:text-xl text-slate-500 text-center max-w-2xl mb-2">
          Analysez et optimisez vos créatifs publicitaires avec l'IA
        </p>
      </div>
