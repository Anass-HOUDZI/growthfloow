    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/20 to-indigo-50/30 flex flex-col">
      ...
      <div className="flex-1 flex flex-col">
        <main className="flex-1 w-full">
          ...
          <section className={`relative overflow-hidden ${isMobile ? 'py-20 px-4' : 'py-32 px-8'}`}>
            ...
            <div className="relative max-w-6xl mx-auto text-center">
              ...
              <div className="inline-flex items-center space-x-2 mb-8 px-5 py-3 bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200/50 rounded-full shadow-sm">
                <Sparkles className="w-5 h-5 text-blue-600 animate-pulse" />
                <span className="text-blue-700 font-semibold text-sm sm:text-base">OpenToolsAI Growth Suite</span>
                <Sparkles className="w-5 h-5 text-purple-600 animate-pulse" />
              </div>
              
              <h1 className={`${isMobile ? 'text-4xl' : 'text-6xl md:text-8xl'} font-black mb-8 tracking-tight leading-tight`}>
              ...
              <p className={`${isMobile ? 'text-lg' : 'text-xl md:text-2xl'} text-slate-600 max-w-4xl mx-auto mb-10 leading-relaxed font-medium px-4`}>
              ...
              <div className={`flex ${isMobile ? 'flex-col space-y-4' : 'items-center justify-center space-x-8'} mb-12`}>
                <div className="flex items-center justify-center space-x-4 sm:space-x-6 text-xs sm:text-sm">
                  <div className="flex items-center space-x-2 text-emerald-600 bg-emerald-50 px-4 sm:px-5 py-2.5 rounded-full border border-emerald-200/50 shadow-sm">
                    <div className="w-2 h-2 bg-emerald-500 rounded-full animate-pulse" />
                    <span className="font-semibold">100% gratuit</span>
                  </div>
                  <div className="flex items-center space-x-2 text-blue-600 bg-blue-50 px-4 sm:px-5 py-2.5 rounded-full border border-blue-200/50 shadow-sm">
                ...
                {!isMobile && (
                  <div className="flex items-center space-x-6 text-sm">
                    <div className="flex items-center space-x-2 text-violet-600 bg-violet-50 px-5 py-2.5 rounded-full border border-violet-200/50 shadow-sm">
                      <TrendingUp className="w-4 h-4" />
                      <span className="font-semibold">50 outils</span>
                    </div>
                    <div className="flex items-center space-x-2 text-amber-600 bg-amber-50 px-5 py-2.5 rounded-full border border-amber-200/50 shadow-sm">
          ...
          <section ref={toolsRef} className={`${isMobile ? 'px-4 pb-8' : 'px-8 pb-16'}`}>
            <div className="max-w-7xl mx-auto">
              ...
              <div className="mt-12 sm:mt-20 mb-12 sm:mb-20">
                <ToolsGrid 
                  selectedCategory={selectedCategory}
                  searchTerm=""
                  favorites={favorites}
