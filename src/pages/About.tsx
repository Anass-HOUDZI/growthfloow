...
const About: React.FC = () => {
  ...
  return (
    <ErrorBoundary FallbackComponent={ErrorFallback}>
      <Suspense fallback={<LoadingState fullScreen text="Chargement de la page À propos..." />}>
        <AppLayoutGlobal onLogoClick={handleLogoClick}>
          <div className="max-w-4xl mx-auto px-6 py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <ErrorBoundary FallbackComponent={ErrorFallback}>
                <Suspense fallback={<LoadingState text="Chargement des cartes..." />}>
            ...
            <ErrorBoundary FallbackComponent={ErrorFallback}>
              <Suspense fallback={<LoadingState text="Chargement du contenu..." />}>
