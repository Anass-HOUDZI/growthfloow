    ...
    <section className={`relative overflow-hidden ${isMobile ? 'py-8 px-4' : 'py-12 px-8'}`}>
      ...
      <div className="relative max-w-6xl mx-auto text-center">
        ...
        <p className={`${isMobile ? 'text-base' : 'text-lg md:text-xl'} text-slate-600 max-w-4xl mx-auto mb-8 leading-relaxed font-medium px-4`}>
          50 outils professionnels de growth marketing, <span className="text-primary font-semibold">100% gratuits</span> et <span className="text-primary font-semibold">privacy-first</span>
        </p>
        ...
        <div className="flex flex-col items-center justify-center space-y-4">
          <button 
            ...
            className="group text-white px-8 sm:px-12 py-4 sm:py-5 rounded-2xl font-bold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center space-x-3 text-base sm:text-lg focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 hover:opacity-90"
